...
#define Random_Resolution                 16u
#define Random_UsingFixedFunction         1u
...
#define Random_INIT_PERIOD             999u
#define Random_INIT_CAPTURE_MODE       ((uint8)((uint8)1u << Random_CTRL_CAP_MODE_SHIFT))
...
***************************************/
    ...
    ***************************************/
    ...
    #define Random_CONTROL             (* (reg8 *) Random_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define Random_CAPTURE_LSB         (* (reg8 *) Random_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define Random_CAPTURE_LSB_PTR       ((reg8 *) Random_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define Random_PERIOD_LSB          (* (reg8 *) Random_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define Random_PERIOD_LSB_PTR        ((reg8 *) Random_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define Random_COUNTER_LSB         (* (reg8 *) Random_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define Random_COUNTER_LSB_PTR       ((reg8 *) Random_TimerUDB_sT16_timerdp_u0__A0_REG )
    #elif(Random_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define Random_CAPTURE_LSB         (* (reg16 *) Random_TimerUDB_sT16_timerdp_u0__F0_REG )
            #define Random_CAPTURE_LSB_PTR       ((reg16 *) Random_TimerUDB_sT16_timerdp_u0__F0_REG )
            #define Random_PERIOD_LSB          (* (reg16 *) Random_TimerUDB_sT16_timerdp_u0__D0_REG )
            #define Random_PERIOD_LSB_PTR        ((reg16 *) Random_TimerUDB_sT16_timerdp_u0__D0_REG )
            #define Random_COUNTER_LSB         (* (reg16 *) Random_TimerUDB_sT16_timerdp_u0__A0_REG )
            #define Random_COUNTER_LSB_PTR       ((reg16 *) Random_TimerUDB_sT16_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define Random_CAPTURE_LSB         (* (reg16 *) Random_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define Random_CAPTURE_LSB_PTR       ((reg16 *) Random_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define Random_PERIOD_LSB          (* (reg16 *) Random_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define Random_PERIOD_LSB_PTR        ((reg16 *) Random_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define Random_COUNTER_LSB         (* (reg16 *) Random_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
            #define Random_COUNTER_LSB_PTR       ((reg16 *) Random_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(Random_Resolution <= 24u)/* 24-bit Timer */
        #define Random_CAPTURE_LSB         (* (reg32 *) Random_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define Random_CAPTURE_LSB_PTR       ((reg32 *) Random_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define Random_PERIOD_LSB          (* (reg32 *) Random_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define Random_PERIOD_LSB_PTR        ((reg32 *) Random_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define Random_COUNTER_LSB         (* (reg32 *) Random_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define Random_COUNTER_LSB_PTR       ((reg32 *) Random_TimerUDB_sT16_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define Random_CAPTURE_LSB         (* (reg32 *) Random_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define Random_CAPTURE_LSB_PTR       ((reg32 *) Random_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define Random_PERIOD_LSB          (* (reg32 *) Random_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define Random_PERIOD_LSB_PTR        ((reg32 *) Random_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define Random_COUNTER_LSB         (* (reg32 *) Random_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
            #define Random_COUNTER_LSB_PTR       ((reg32 *) Random_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define Random_COUNTER_LSB_PTR_8BIT       ((reg8 *) Random_TimerUDB_sT16_timerdp_u0__A0_REG )

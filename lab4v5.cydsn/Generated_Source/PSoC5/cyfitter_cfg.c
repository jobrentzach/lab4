...
#define BS_PICU_4_VAL ((const uint8 CYFAR *)0x480004E8u)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000590u)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x4800059Cu)
